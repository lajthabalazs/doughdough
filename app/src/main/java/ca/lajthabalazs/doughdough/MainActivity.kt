package ca.lajthabalazs.doughdough
...
import ca.lajthabalazs.doughdough.ui.theme.DoughDoughTheme
import ca.lajthabalazs.doughdough.ui.NavGraph
...
class MainActivity : ComponentActivity() {
    ...
    private fun checkIntentForTaskStep(intent: Intent?) {
        ...
        if (step != null) {
            ca.lajthabalazs.doughdough.ui.AppState.pendingOpenTaskStep = step
        }
    }
